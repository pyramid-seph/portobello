...
@export_color_no_alpha var font_outline_color_normal: Color = Color.BLACK:
	set(value):
		font_outline_color_normal = value
		if Engine.is_editor_hint():
			_change_label_1_outline_color(font_outline_color_normal)
			_change_label_2_outline_color(font_outline_color_normal)
	get:
		return font_outline_color_normal
@export_color_no_alpha var font_outline_color_fade: Color = Color.MAGENTA
...
func start(override_duration_sec: float = -1) -> void:
	...
	_change_label_2_outline_color(Color.TRANSPARENT)
	...
	_tween.tween_callback(_change_label_2_outline_color.bind(font_outline_color_normal))
	...
	_tween.parallel().tween_method(
		_change_label_2_outline_color,
		font_outline_color_normal,
		font_outline_color_fade,
		FADE_OUT_DURATION_SEC
	).set_trans(Tween.TRANS_LINEAR)
...
func _change_label_1_outline_color(color: Color) -> void:
	Utils.change_label_outline_color(_label_1, color)


func _change_label_2_outline_color(color: Color) -> void:
	Utils.change_label_outline_color(_label_2, color)
